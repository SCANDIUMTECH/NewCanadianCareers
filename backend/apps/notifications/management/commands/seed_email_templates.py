...
TEMPLATE_META = {
    'welcome': {
        'name': 'Welcome Email',
        'type': 'Transactional',
        'subject': 'Welcome to NewCanadian.Careers, {{ name }}',
        'preheader': 'Your account is ready. Start exploring opportunities on NewCanadian.Careers.',
    ...
    'email_verification': {
        ...
        'preheader': 'Verify your email to activate your NewCanadian.Careers account.',
    ...
    'password_reset': {
        ...
        'preheader': 'Reset your NewCanadian.Careers password. This link expires in 1 hour.',
        'variables': ['name', 'reset_url', 'current_year'],
    },
    'security_alert': {
        'name': 'Security Alert',
        'type': 'System',
        'subject': 'Security alert on your NewCanadian.Careers account',
        'preheader': 'Multiple failed login attempts detected on your NewCanadian.Careers account.',
    ...
    'fraud_alert': {
        ...
        'preheader': '{{ severity }} fraud alert triggered on NewCanadian.Careers.',
        'variables': [
    ...
    'job_approved': {
        ...
        'preheader': 'Your job posting "{{ job_title }}" is now live on NewCanadian.Careers.',
    ...
    'account_verified': {
        ...
        'preheader': 'Your {{ entity_type }} has been verified on NewCanadian.Careers.',
        'variables': ['name', 'entity_type', 'dashboard_url', 'current_year'],
    },
    'team_invite': {
        'name': 'Team Invitation',
        'type': 'Transactional',
        'subject': 'Join {{ company_name }} on NewCanadian.Careers',
        'preheader': '{{ inviter_name }} invited you to join {{ company_name }} on NewCanadian.Careers.',
    ...
    'account_locked': {
        ...
        'preheader': 'Your NewCanadian.Careers account has been temporarily locked due to multiple failed login attempts.',
    ...
    'account_suspended': {
        ...
        'preheader': 'Your NewCanadian.Careers account has been suspended.',
    ...
    'account_reactivated': {
        ...
        'preheader': 'Your NewCanadian.Careers account has been reactivated.',
    ...
    'security_confirmation': {
        ...
        'preheader': 'Your {{ change_type }} was successfully changed on NewCanadian.Careers.',
    ...
    'account_deleted': {
        ...
        'preheader': 'Your NewCanadian.Careers account has been permanently deleted.',
        'variables': ['name', 'current_year'],
    },
    ...
    'default': {
        ...
        'type': 'System',
        'subject': 'Notification from NewCanadian.Careers',
        'preheader': '',
