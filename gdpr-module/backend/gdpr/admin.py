...
class ConsentHistoryAdmin(admin.ModelAdmin):
    ...
    search_fields = ["ip_address", "service_name", "user__username"]
    readonly_fields = [
...
class AdminAuditLogAdmin(admin.ModelAdmin):
    ...
    search_fields = ["description", "target_model", "user__username"]
    readonly_fields = [
...
class GDPRSettingsAdmin(admin.ModelAdmin):
    fieldsets = (
        ...
        ("Behavior", {
            ...
            "description": "⚠️ first_visit_allow_all and returning_visitor_allow_all are NON-COMPLIANT in EU/EEA.",
        }),
        ("Features", {"fields": (
