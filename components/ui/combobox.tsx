...
function ComboboxList({
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- render prop receives items from collection with varying types
...
function ComboboxEmpty({ className, ...props }: ComboboxPrimitive.Empty.Props) {
  return (
    <ComboboxPrimitive.Empty
      ...
      className={cn(
        "text-muted-foreground hidden w-full justify-center py-2 text-center text-sm group-data-[slot=combobox-list]/combobox-content:data-empty:flex",
        className
      )}
      {...props}
    />
