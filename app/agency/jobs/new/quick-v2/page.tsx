...
import { QuickJobPostPremium } from "@/components/quick-job-post-v2/quick-job-post-premium"

function QuickJobPostV2Content() {
  ...
  return <QuickJobPostPremium initialCompanyId={initialCompanyId} />
}

export default function QuickJobPostV2Page() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen flex items-center justify-center">
